...
namespace Lab3_Haotian_Zhang.NorthwindDataSetTableAdapters {
...
SELECT OrderID, ProductID, UnitPrice, Quantity, Discount FROM [Order Details] WHERE (OrderID = @OrderID) AND (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Lab3_Haotian_Zhang.Properties.Settings.Default.NorthwindConnectionString;
        }
